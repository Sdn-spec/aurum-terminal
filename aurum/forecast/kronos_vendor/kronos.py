...
# Vendored from https://github.com/shiyu-coder/Kronos (MIT License, Copyright (c) 2025 ShiYu).
# Original imported this as `from model.module import *`; adjusted to a
# package-relative import for aurum's layout, no other changes.
from .module import *
